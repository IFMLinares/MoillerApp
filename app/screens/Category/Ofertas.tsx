...
type ProductsScreenProps = StackScreenProps<RootStackParamList, "Ofertas">;

// Define el tipo SortCriteria
type SortCriteria = string;

const Ofertas = ({ navigation, route }: ProductsScreenProps) => {
  ...
  const loadArticles = async () => {
    ...
    try {
      const { articles: newArticles, next } = await fetchArticles(
        clienteId,
        page,
        false, // No es necesario filtrar por "mostSold"
