...
type ProductsScreenProps = StackScreenProps<RootStackParamList, "MasVendido">;

// Define el tipo SortCriteria
type SortCriteria = string;

const MasVendido = ({ navigation, route }: ProductsScreenProps) => {
  ...
  const loadArticles = async () => {
    ...
    try {
      const { articles: newArticles, next } = await fetchArticles(
        clienteId,
        page,
        true // Pasa true para incluir most_sold
      );
